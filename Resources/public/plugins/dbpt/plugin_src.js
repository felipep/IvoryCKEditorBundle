...
CKEDITOR.plugins.add("dbpt", {
	...
	init : function(a) {
		...
		CKEDITOR.dialog.addIframe('dbpt_dialog', 'Duden Korrektor für CKEditor', this.path + 'dialogs/spellchecker.html', 800, 600, function(){});
		...
		a.ui.addButton("DBPT Dictionary", {
			label: "Benutzerwörterbuch anzeigen",//"DBPT Dictionary",//a.lang.about.title,
			command: "dbptdict",
		...
		a.ui.addButton("DBPT Exceptions", {
			label: "Ausnahmewörterbuch anzeigen",//"DBPT Exceptions",//a.lang.about.title,
			command: "dbptexc",
